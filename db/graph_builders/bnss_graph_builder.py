...
class BNSSGraphBuilder:
    ...
    def build(self, bnss):
        ...
        if getattr(bnss, "parts", None):
            self._build_parts(bnss)
        else:
            self._build_chapters(bnss.chapters, self.DOCUMENT_ID)
    ...
    def _build_parts(self, bnss):
        for part in bnss.parts:

            part_id = f"BNSS-PART-{part.part_no}"
    ...
    def _build_chapters(self, chapters, parent_id):
        for chapter in chapters:
            ...
            chapter_id = f"BNSS-CH-{chapter.chapter_no}"
    ...
    def _build_sections(self, sections, chapter_id):
        for section in sections:
            ...
            section_id = f"BNSS-{section.section_no}"
    ...
    # =====================================================
    # CLAUSES → SUBCLAUSES → ROMANCLAUSES
    # =====================================================
